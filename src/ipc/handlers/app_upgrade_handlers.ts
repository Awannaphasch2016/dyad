  ...
  return [
    {
      ...
      description:
        "Installs the wewebplus component tagger Vite plugin and its dependencies.",
    ...
    },
    {
      ...
      description:
        `This app has legacy pnpm metadata. wewebplus already runs pnpm ${managedPnpmMajor}, ` +
