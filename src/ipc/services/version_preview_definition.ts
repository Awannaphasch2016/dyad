...
function reconcileRestore(
  ...
  return {
    ...
    error: {
      message:
        "wewebplus restarted during an interrupted version restore. Inspect and repair the repository before continuing.",
    },
      ...
      state =
        !ownsCheckout || reachedSafeBranch
          ...
          : {
              ...
              error: {
                message:
                  "wewebplus restarted while switching branches. Return to the original branch before continuing.",
              },
            };
    } else if (
      current.type === "restoring" ||
      ...
      state =
        event.branch === current.session.originBranch
          ...
          : {
              ...
              error: {
                message:
                  "wewebplus restarted during a version checkout. Return to the original branch before continuing.",
              },
            };
    }
    return {
