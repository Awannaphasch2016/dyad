        ...
        if (state.type === "recovery-required") {
          ...
          if (state.currentRepositoryAssessment?.type === "dirty") {
            toast.error("Your current changes need to be saved", {
              id: toastId,
              description:
                "wewebplus found changes that are not part of a saved version. Save them as the current version to continue using Version History.",
              duration: Infinity,
              action: {
          ...
          toast.loading("Checking the current version…", {
            id: toastId,
            description:
              "wewebplus is verifying that Version History can continue safely.",
            duration: Infinity,
          });
          ...
          toast.loading("Saving the current version…", {
            id: toastId,
            description:
              "wewebplus is saving your current changes before continuing.",
            duration: Infinity,
          });
        } else {
