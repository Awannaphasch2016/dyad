...
export const SETTINGS_SEARCH_INDEX: SearchableSettingItem[] = [
  ...
  },
  {
    ...
    label: "Node Runtime",
    description: "Choose between system Node.js and wewebplus-managed Node.js",
  ...
  },
  {
    ...
    description:
      "Set the top-level folder that wewebplus will store new applications in",
  ...
  {
    id: SETTING_IDS.cloudflare,
    label: "Cloudflare Integration",
    description: "Manage the Cloudflare API token used for Worker deployments",
    keywords: ["cloudflare", "workers", "deploy", "integration", "token"],
    sectionId: SECTION_IDS.integrations,
    sectionLabel: "Integrations",
  },
  {
  ...
  },
  {
    ...
    description:
      "In Agent mode, use a fast model to judge each MCP tool call and skip the consent prompt for safe ones. Risky actions still require approval. Requires wewebplus Pro",
    keywords: [
      "mcp",
      "consent",
      "approve",
...

  {
    ...
    label: "Allow deployment to Cloudflare Workers",
    description:
      "Deploy a Cloudflare Worker from your app when you sync changes to GitHub",
    keywords: [
      "deploy",
      "deployment",
      "cloudflare",
