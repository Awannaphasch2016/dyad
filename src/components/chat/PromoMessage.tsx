...
export const PROMO_MESSAGES: PromoMessageConfig[] = [
  {
    id: "pro-trial",
    text: "Build more with wewebplus Pro — free for 7 days.",
  ...
  {
    id: "agent-mode",
    text: "Let wewebplus Pro fix bugs with Agent mode.",
    cta: "Get wewebplus Pro",
    target: { type: "trial-dialog" },
    weight: 3,
  },
  {
  ...
  {
    id: "speech-to-text",
    text: "Tired of typing? Talk to wewebplus with your voice.",
    cta: "Get wewebplus Pro",
    target: { type: "trial-dialog" },
    weight: 3,
  },
  {
    id: "web-search",
    text: "Let wewebplus use the web for fresh information and better builds.",
    cta: "Get wewebplus Pro",
    target: { type: "trial-dialog" },
    weight: 2,
  },
  {
    id: "pro-tools",
    text: "Recreate a website with wewebplus Pro.",
    cta: "Unlock wewebplus Pro",
    target: { type: "trial-dialog" },
    weight: 2,
  },
  {
  ...
  {
    id: "github-star",
    text: "Enjoying wewebplus? Star us on GitHub.",
    cta: "Star on GitHub",
  ...
  {
    id: "reddit",
    text: "Join 4000+ builders in the wewebplus subreddit.",
  ...
  {
    id: "follow-x",
    text: "Follow wewebplus on X for build tips and release updates.",
    cta: "Follow @dyad_sh",
