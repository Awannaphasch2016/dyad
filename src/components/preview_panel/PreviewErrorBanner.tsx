          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            {(isInternalDyadError || isSyncError) && (
              <span className="shrink-0 rounded bg-red-100 px-1.5 py-0.5 text-xs font-medium text-red-700 dark:bg-red-900 dark:text-red-300">
                {isSyncError ? "Cloud sync issue" : "Internal wewebplus error"}
              </span>
            )}
          </div>
        </div>
          ...
          <div className="mt-2 flex items-start gap-2 text-sm text-red-700 dark:text-red-200">
            ...
            <span>
              {isDockerError
                ...
                : isSyncError
                  ? "wewebplus could not upload your latest local changes to the cloud sandbox. Check your network connection or wait for sync to recover."
                  : isInternalDyadError
                    ? "Try restarting the wewebplus app or your computer."
